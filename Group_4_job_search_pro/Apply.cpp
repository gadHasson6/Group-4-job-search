...
void Apply::printEmployer() const {
    ...
    cout << "Submission Date: " << this -> submissionDate.printDate() << endl;
...
void Apply::setJobID(long jobID) {
    this ->  jobID = jobID;}
void Apply::setJob(Job* job) {
    this->job = job;}
void Apply::setCandidate(Candidate* candidate) {
    this->candidate = candidate;}
void Apply::setSubmissionDate(const Date& submissionDate) {
    this->submissionDate = submissionDate;}
void Apply::setSubmissionStatus(const std::string& submissionStatus) {
    this->submissionStatus = submissionStatus;}
